                     ...
                     <div class="about-service-container">
                        <div class="row">
                           <div class="col-lg-4">
                              <div class="about-service">
                                 <div class="about-service-icon">
                                    <img src="<?= base_url(); ?>assets/images/icon15.png" alt="">
                                 </div>
                           ...
                           <div class="col-lg-4">
                              <div class="about-service">
                                 <div class="about-service-icon">
                                    <img src="<?= base_url(); ?>assets/images/icon16.png" alt="">
                                 </div>
                                 <div class="about-service-content">
                           ...
                           <div class="col-lg-4">
                              <div class="about-service">
                                 <div class="about-service-icon">
                                    <img src="<?= base_url(); ?>assets/images/icon17.png" alt="">
                                 </div>
                                 <div class="about-service-content">
                  ...
                  <div class="container">
                     ...
                     <div class="client-wrap client-slider">
                        <div class="client-item">
                           <figure>
                              <img src="<?= base_url(); ?>assets/images/logo7.png" alt="">
                           </figure>
                        </div>
                        <div class="client-item">
                           <figure>
                              <img src="<?= base_url(); ?>assets/images/logo8.png" alt="">
                           </figure>
                        </div>
                        <div class="client-item">
                           <figure>
                              <img src="<?= base_url(); ?>assets/images/logo9.png" alt="">
                           </figure>
                        </div>
                        <div class="client-item">
                           <figure>
                              <img src="<?= base_url(); ?>assets/images/logo10.png" alt="">
                           </figure>
                        </div>
                        <div class="client-item">
                           <figure>
                              <img src="<?= base_url(); ?>assets/images/logo11.png" alt="">
                           </figure>
                        </div>
                        <div class="client-item">
                           <figure>
