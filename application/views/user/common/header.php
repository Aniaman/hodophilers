...
<head>
  <meta charset="utf-8" />
  <title>Hodophilers - Admin Dashboard</title>
  ...
  <link href="<?= base_url(); ?>admin_assets/plugins/daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
  <link href="<?= base_url(); ?>admin_assets/assets/css/app.min.css" rel="stylesheet" type="text/css" />

  <link rel="stylesheet" href="<?= base_url(); ?>admin_assets/plugins/jquery-steps/jquery.steps.css">

  <!-- DataTables -->
  <link href="<?= base_url(); ?>admin_assets/plugins/datatables/dataTables.bootstrap5.min.css" rel="stylesheet" type="text/css" />
