            ...
            <div class="card-body p-0">
              ...
              <div class="tab-content">
                <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">
                  ...
                  <?php } ?>
                  <?= form_open('user-login', 'class="form-horizontal auth-form"') ?>
        ...
        <?php } ?>
                  <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                      <input type="email" class="form-control" value="<?= get_cookie('userRememberme[email]') ?>" name="emailId" placeholder="Enter your Email Id">
                    </div>
                  ...
                  <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                      <input type="password" class="form-control" name="password" value="<?= get_cookie('userRememberme[password]') ?>" id="userpassword" placeholder="Enter password"/>                     
                    </div>
                  ...
                  <div class="m-3 text-center text-muted">
                                                <p class="mb-0">Don't have an account ?  <a href="<?= base_url('user-sign-up') ?>" class="text-primary ms-2">Free Resister</a></p>
                                            </div>
                                            ...
                                            <div class="btn-group w-100">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-secondary">Google <i class="fab fa-google-plus-g"></i></button>
                                            </div>
                </div>
